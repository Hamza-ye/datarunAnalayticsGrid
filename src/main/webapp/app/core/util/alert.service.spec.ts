...
describe('Alert service test', () => {
  describe('Alert Service Test', () => {
    ...
    it('should produce an alert object with correct id', inject([AlertService], (service: AlertService) => {
      service.addAlert({ type: 'info', message: 'Datarun info' });
      expect(service.addAlert({ type: 'success', message: 'Datarun success' })).toEqual(
        expect.objectContaining({
          type: 'success',
          message: 'Hello Datarun success',
          id: 1,
        } as Alert),
      );
    ...
    it('should close an alert correctly', inject([AlertService], (service: AlertService) => {
      const alert0 = service.addAlert({ type: 'info', message: 'Hello Datarun info' });
      const alert1 = service.addAlert({ type: 'info', message: 'Hello Datarun info 2' });
      const alert2 = service.addAlert({ type: 'success', message: 'Hello Datarun success' });
    ...
    it('should close an alert on timeout correctly', inject([AlertService], (service: AlertService) => {
      service.addAlert({ type: 'info', message: 'Hello Datarun info' });
    ...
    it('should clear alerts', inject([AlertService], (service: AlertService) => {
      service.addAlert({ type: 'info', message: 'Hello Datarun info' });
      service.addAlert({ type: 'danger', message: 'Hello Datarun info' });
      service.addAlert({ type: 'success', message: 'Hello Datarun info' });
      expect(service.get().length).toBe(3);
      service.clear();
      expect(service.get().length).toBe(0);
    }));
    ...
    it('should produce a success message', inject([AlertService], (service: AlertService) => {
      expect(service.addAlert({ type: 'success', message: 'Hello Datarun' })).toEqual(
        expect.objectContaining({
          type: 'success',
          message: 'Hello Datarun',
        } as Alert),
    ...
    it('should produce a success message with custom position', inject([AlertService], (service: AlertService) => {
      expect(service.addAlert({ type: 'success', message: 'Hello Datarun', position: 'bottom left' })).toEqual(
        expect.objectContaining({
          type: 'success',
          message: 'Hello Datarun',
    ...
    it('should produce a error message', inject([AlertService], (service: AlertService) => {
      expect(service.addAlert({ type: 'danger', message: 'Hello Datarun' })).toEqual(
        expect.objectContaining({
          type: 'danger',
          message: 'Hello Datarun',
        } as Alert),
    ...
    it('should produce a warning message', inject([AlertService], (service: AlertService) => {
      expect(service.addAlert({ type: 'warning', message: 'Hello Datarun' })).toEqual(
        expect.objectContaining({
          type: 'warning',
          message: 'Hello Datarun',
        } as Alert),
    ...
    it('should produce a info message', inject([AlertService], (service: AlertService) => {
      expect(service.addAlert({ type: 'info', message: 'Hello Datarun' })).toEqual(
        expect.objectContaining({
          type: 'info',
          message: 'Hello Datarun',
        } as Alert),
