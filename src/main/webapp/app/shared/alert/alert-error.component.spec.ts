...
describe('Alert Error Component', () => {
  ...
  describe('Error Handling', () => {
    it('should display an alert on status 0', () => {
      // GIVEN
      eventManager.broadcast({ name: 'datarunAnalayticsGridApp.httpError', content: { status: 0 } });
      // THEN
    ...
    it('should display an alert on status 404', () => {
      // GIVEN
      eventManager.broadcast({ name: 'datarunAnalayticsGridApp.httpError', content: { status: 404 } });
      // THEN
      expect(comp.alerts().length).toBe(1);
    ...
    it('should display an alert on generic error', () => {
      // GIVEN
      eventManager.broadcast({ name: 'datarunAnalayticsGridApp.httpError', content: { error: { message: 'Error Message' } } });
      eventManager.broadcast({ name: 'datarunAnalayticsGridApp.httpError', content: { error: 'Second Error Message' } });
      // THEN
    ...
    it('should display an alert on status 400 for generic error', () => {
      ...
      const response = new HttpErrorResponse({
        ...
        error: {
          type: 'https://www.nmcpy.org/problem/problem-with-message',
          title: 'Bad Request',
          status: 400,
          path: '/api/foos',
      ...
      eventManager.broadcast({ name: 'datarunAnalayticsGridApp.httpError', content: response });
      // THEN
      expect(comp.alerts().length).toBe(1);
    ...
    it('should display an alert on status 400 for invalid parameters', () => {
      ...
      const response = new HttpErrorResponse({
        ...
        statusText: 'Bad Request',
        error: {
          type: 'https://www.nmcpye.org/problem/problem-with-message',
